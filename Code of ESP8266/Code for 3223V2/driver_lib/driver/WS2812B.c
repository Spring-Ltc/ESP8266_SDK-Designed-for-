...
void ColorDepthUpdate(uint8_t depth);
...
void ColorArrayUpdate(uint16_t star)
{
	...
	for(i=0;i<LedNumMAX;i++)
	{
		...
		{
			case 0:
				R_buffer[star] = ColorDepth;G_buffer[star] = 0x00;B_buffer[star] = 0x00;break;
			case 1:
				R_buffer[star] = 0x00;G_buffer[star] = ColorDepth;B_buffer[star] = 0x00;break;
			case 2:
				R_buffer[star] = 0x00;G_buffer[star] = 0x00;B_buffer[star] = ColorDepth;break;
			case 3:
				R_buffer[star] = ColorDepth;G_buffer[star] = ColorDepth;B_buffer[star] = 0x00;break;
			case 4:
				R_buffer[star] = ColorDepth;G_buffer[star] = 0x00;B_buffer[star] = ColorDepth;break;
			case 5:
				R_buffer[star] = 0x00;G_buffer[star] = ColorDepth;B_buffer[star] = ColorDepth;break;
			case 6:
				R_buffer[star] = ColorDepth;G_buffer[star] = ColorDepth;B_buffer[star] = ColorDepth;break;
		}
		star++;
